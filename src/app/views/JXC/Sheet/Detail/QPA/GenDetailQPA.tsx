...
import { AtomMetricSpec, DetailAtomSpec, EditingRow, SheetRow } from "app/tool";
...
export abstract class GenDetailQPA extends GenDetailGoods {
    ...
    readonly addRow = async (genEditing: GenEditing): Promise<SheetRow[]> => {
        ...
        let editingRow = this.editingRowFromAtom(atomMetricSpec);
    ...
    protected editingRowFromAtom(atomMetricSpec: AtomMetricSpec): EditingRow {
        if (atomMetricSpec === undefined) return;
        let row: DetailAtomSpec = {
            item: undefined,
    ...
    protected PageDetail = ({ header, editingRow }: { header?: string; editingRow?: EditingRow; }): JSX.Element => {
        ...
        let detail: DetailAtomSpec;
        if (details === undefined) {
            detail = {} as DetailAtomSpec;
        }
        else {
            detail = details[0];
        }
        ...
        <div className="row">
            ...
            <div className={cnCol + ' d-flex justify-content-end align-items-end'}>
                <div className="text-end">
                    ...
                    <br />
                    <small>数量:</small> <b>{value}</b> <span>{vMetric}</span>
                </div>
