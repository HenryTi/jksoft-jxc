...
import { PageSEEdit, PageSENew } from "app/hooks";

const pathSheet = 'se';

function PageSECenter() {
...
export function routeSECenter() {
    return <>
        <Route path={centers.se.path} element={<PageSECenter />} />
        <Route path={'se/:sheet/:id'} element={<PageSEEdit />} />
        <Route path={'se/:sheet'} element={<PageSENew />} />
    </>;
}
