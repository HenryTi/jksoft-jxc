...
import { ParamSearchAtomBuds } from "uqs/UqDefault";
import { BizBud, EntityAtom, EntityID, EntityFork, BizPhraseType } from "../../Biz";
import { AtomData, StoreEntity } from "../../Store";

export abstract class IDSelectStore<E extends EntityID> extends StoreEntity<E> {
