...
import { Prop, ViewAtomTitles, ViewShowBuds } from "../../tools";
import { ViewForkAtomBold, ViewForkAtomTitles, ViewForkBuds } from "../../View/Form/ViewForkOfStore";
...
export function ViewPendRow({
    ...
    let iBizSpec = sheetStore.getCacheFork(i);
